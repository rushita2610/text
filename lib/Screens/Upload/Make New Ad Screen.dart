...
class Makenewad_Screen extends StatefulWidget {
  Makenewad_Screen({Key? key,}) : super(key: key);
...
class _Makenewad_ScreenState extends State<Makenewad_Screen> {
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                              fontSize: 14,
                              color: selectedADCategory == "Category"
                                  ? Colors.grey
                                  : maincolor,
                            ),
                            labelStyle: const TextStyle(
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                              fontSize: 14,
                              color: selectedADStock == "Select Stock"
                                  ? Colors.grey
                                  : maincolor,
                            ),
                            labelStyle: const TextStyle(
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                              fontSize: 14,
                              color: selectedADBrand == "Select Brand"
                                  ? Colors.grey
                                  : maincolor,
                            ),
                            labelStyle: const TextStyle(
  ...
  UpdateProfilAPIcall() async {
    ...
    try {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const Myads_Screen()));
